...
file_path = "C:/xampp/htdocs/webapp1/Recording_Sys_and_video_output/"
...
while True:
    ...
    if (counter != 0):
        ...
        if(triggered == False):
            ...
            file_path = "C:/xampp/htdocs/webapp1/Recording_Sys_and_video_output/output_" + str(timeName) + "_" + str(counter) + ".mp4"
            os.remove(file_path)
